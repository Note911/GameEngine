...
void MainGame::initLevel() {
    ...
    _player->addGun(new Gun("Magnum", 10, 1, 0.05f, 30, BULLET_SPEED));
    _player->addGun(new Gun("Shotgun", 30, 12, 0.08f, 4, BULLET_SPEED));
    _player->addGun(new Gun("MP5", 2, 1, 10.0f, 0.08f, BULLET_SPEED));
}
